...
We tested the performance of the tow locking protocol: single mutex lock and Reader-Writer lock. To do this, we created a workload which consists of 50\% insert statements and 50\% read queries. 
